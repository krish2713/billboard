...
export class CognitoUtil {
    ...
    public static _VENDOR_POOL_ID = environment.vendorPoolId;
    ...
    public static _VENDOR_POOL_DATA:any = {
            UserPoolId: CognitoUtil._VENDOR_POOL_ID,
            ClientId: CognitoUtil._VENDOR_CLIENT_ID
     };
    
    public static _ADMIN_POOL_DATA:any = {
            UserPoolId: CognitoUtil._ADMIN_POOL_ID,
            ClientId: CognitoUtil._ADMIN_CLIENT_ID
     };
